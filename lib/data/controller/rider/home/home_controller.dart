...
import 'package:ovoride/data/model/rider/dashboard/dashboard_response_model.dart';
import 'package:ovoride/data/model/global/app/app_payment_method.dart';
import 'package:ovoride/data/model/global/app/app_service_model.dart';
...
import 'package:ovoride/data/model/rider/ride/create_ride_request_model.dart';
import 'package:ovoride/data/model/global/user/global_user_model.dart';
import 'package:ovoride/data/model/rider/ride/create_ride_response_model.dart';
import 'package:ovoride/data/model/rider/ride/ride_fare_response_model.dart';
...
import 'package:ovoride/presentation/screens/rider/home/widgets/bottomsheet/ride_distance_warning_bottom_sheet.dart';
    ...
    try {
      ...
      if (responseModel.statusCode == 200) {
        ...
        if (model.status == MyStrings.success) {
          printX(model.remark);
          clearData();
          if (Get.currentRoute != RouteHelper.riderRideDetailsScreen) {
            Get.toNamed(
              RouteHelper.riderRideDetailsScreen,
