...
import 'package:ovoride/data/model/auth/login/rider_login_response_model.dart';
  ...
  void loginUser() async {
    ...
    try {
      ...
      if (model.statusCode == 200) {
        RiderLoginResponseModel loginModel = RiderLoginResponseModel.fromJson(model.responseJson);
        if (loginModel.status.toString().toLowerCase() == MyStrings.success.toLowerCase()) {
          ...
          await RouteHelper.checkRiderStatusAndGoToNextStep(
