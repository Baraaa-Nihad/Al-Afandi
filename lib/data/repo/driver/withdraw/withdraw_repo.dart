...
import 'package:ovoride/core/utils/method.dart' as request;
import 'package:ovoride/core/utils/method.dart' show Method;
...
import 'package:ovoride/data/model/withdraw/withdraw_history_response_model.dart' as withdraw_history_model;
...
class WithdrawRepo {
  ...
  Future<AuthorizationResponseModel> confirmWithdrawRequest(
    String trx,
  ...
  Future<dynamic> getAllWithdrawHistory(
    ...
    if (responseModel.statusCode == 200) {
      withdraw_history_model.WithdrawHistoryResponseModel model = withdraw_history_model.WithdrawHistoryResponseModel.fromJson(
        (responseModel.responseJson),
      );
