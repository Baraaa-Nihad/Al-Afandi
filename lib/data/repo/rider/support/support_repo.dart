...
import 'package:ovoride/data/model/rider/support/new_ticket_store_model.dart';
...
class SupportRepo {
  ...
  Future<ResponseModel> getSupportMethodsList() async {
    String url = "${UrlContainer.baseUrl}${UrlContainer.riderSupportMethodsEndPoint}";
  ...
  Future<ResponseModel> getSupportTicketList(String page) async {
    String url = "${UrlContainer.baseUrl}${UrlContainer.riderSupportListEndPoint}?page=$page";
    final response = await apiClient.request(
      url,
      Method.getMethod,
      null,
  ...
  Future<dynamic> storeTicket(TicketStoreModel model) async {
    ...
    String url = "${UrlContainer.baseUrl}${UrlContainer.riderStoreSupportEndPoint}";
  ...
  Future<dynamic> getSingleTicket(String ticketId) async {
    String url = '${UrlContainer.baseUrl}${UrlContainer.riderSupportViewEndPoint}/$ticketId';
  ...
  Future<dynamic> replyTicket(
    ...
    try {
      String url = "${UrlContainer.baseUrl}${UrlContainer.riderSupportReplyEndPoint}/$ticketId";
  ...
  Future<dynamic> closeTicket(String ticketId) async {
    String url = '${UrlContainer.baseUrl}${UrlContainer.riderSupportCloseEndPoint}/$ticketId';
    ResponseModel response = await apiClient.request(
      url,
      Method.postMethod,
      null,
