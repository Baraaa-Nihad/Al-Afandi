class UrlContainer {
  ...
  static const String riderChangePasswordEndPoint = 'change-password';
  static const String countryEndPoint = 'get-countries';
  static const String deviceTokenEndPoint = 'driver/save-device-token';
  static const String riderDeviceTokenEndPoint = 'save-device-token';
  ...
  static const String riderRideList = 'ride/list';
  ...
  static const String riderReviewRide = 'review';
  static const String riderGetDriverReview = 'get-driver-review';
  ...
  static const String riderRegisterEndPoint = 'register';
  static const String riderLogoutUrl = 'logout';
  static const String riderSocialLoginEndPoint = 'social-login';
  static const String riderForgetPasswordEndPoint = 'password/email';
  static const String riderPasswordVerifyEndPoint = 'password/verify-code';
  static const String riderResetPasswordEndPoint = 'password/reset';
  static const String riderVerify2FAUrl = 'verify-g2fa';
  static const String riderOtpVerify = 'otp-verify';
  static const String riderOtpResend = 'otp-resend';
  static const String riderVerifyEmailEndPoint = 'verify-email';
  static const String riderVerifySmsEndPoint = 'verify-mobile';
  static const String riderResendVerifyCodeEndPoint = 'resend-verify/';
  static const String riderAuthorizationCodeEndPoint = 'authorization';
  static const String dashBoardUrl = 'dashboard';
  static const String paymentHistoryEndpoint = 'payment/history';
  static const String riderDepositHistoryUrl = 'deposit/history';
  static const String riderDepositMethodUrl = 'deposit/methods';
  static const String riderAddMoneyUrl = 'add-money';
  static const String riderUserDeleteEndPoint = 'delete-account';
  static const String riderSupportMethodsEndPoint = 'support/method';
  static const String riderSupportListEndPoint = 'ticket';
  static const String riderStoreSupportEndPoint = 'ticket/create';
  static const String riderSupportViewEndPoint = 'ticket/view';
  static const String riderSupportReplyEndPoint = 'ticket/reply';
  static const String riderSupportCloseEndPoint = 'ticket/close';
