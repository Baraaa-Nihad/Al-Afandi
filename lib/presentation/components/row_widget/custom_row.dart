...
import 'package:ovoride/presentation/screens/driver/withdraw/widget/status_widget.dart';
            ...
            ? Column(
                ...
                children: [
                  ...
                  Text(
                    lastText.tr,
                    style: regularDefault.copyWith(
                      color: isStatus ? statusTextColor : MyColor.primaryColor,
                    ),
                  ),
                  const SizedBox(height: 5),
                ],
                      ...
                      isStatus
                          ...
                          : Flexible(
                              child: Text(
                                ...
                                maxLines: 2,
                                style: regularDefault.copyWith(
                                  color: isStatus ? MyColor.greenSuccessColor : MyColor.getBodyTextColor(),
                                ),
                                overflow: TextOverflow.ellipsis,
