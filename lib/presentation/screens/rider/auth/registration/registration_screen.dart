...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void initState() {
    ...
    Get.put(RegistrationController(registrationRepo: Get.find(tag: 'rider'), generalSettingRepo: Get.find()), tag: 'rider');
  ...
  Widget build(BuildContext context) {
    return WillPopWidget(
      ...
      child: AnnotatedRegionWidget(
        ...
        child: GetBuilder<RegistrationController>(tag: 'rider',
