...
import 'package:ovoride/data/controller/rider/auth/sms_verification_controler.dart';
...
class _SmsVerificationScreenState extends State<SmsVerificationScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(SmsVerificationController(repo: Get.find(tag: 'rider')));
    super.initState();
