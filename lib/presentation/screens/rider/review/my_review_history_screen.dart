...
class RiderMyReviewHistoryScreen extends StatefulWidget {
  final String avgRating;
  const RiderMyReviewHistoryScreen({super.key, required this.avgRating});

  @override
  State<RiderMyReviewHistoryScreen> createState() => _RiderMyReviewHistoryScreenState();
}

class _RiderMyReviewHistoryScreenState extends State<RiderMyReviewHistoryScreen> {
  @override
  void initState() {
