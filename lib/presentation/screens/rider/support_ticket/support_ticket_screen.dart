...
import 'package:ovoride/data/controller/rider/support/support_controller.dart';
      ...
      builder: (controller) {
        return Scaffold(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return CustomAppCard(
                                    onPressed: () {
                                      ...
                                      Get.toNamed(RouteHelper.riderTicketDetailsScreen, arguments: [id, subject])?.then((v) {
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () {
              Get.toNamed(RouteHelper.riderNewTicketScreen)?.then(
