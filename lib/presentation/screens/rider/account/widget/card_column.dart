            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    header.tr,
                    style: headerTextDecoration ?? regularDefault.copyWith(color: MyColor.getTextColor().withValues(alpha: 0.6)),
                    overflow: TextOverflow.ellipsis,
                  ),
                  SizedBox(height: space),
                  Text(
                    body.tr,
                    style: bodyTextDecoration ?? boldDefault.copyWith(fontSize: Dimensions.fontExtraLarge - 1, color: textColor ?? MyColor.getTextColor()),
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                  ),
                ],
