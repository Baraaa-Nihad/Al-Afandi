...
import 'package:ovoride/core/utils/ticket_helper.dart';
import 'package:ovoride/data/controller/shared/support/support_controller.dart';
import 'package:ovoride/data/repo/shared/support/support_repo.dart';
...
import 'package:ovoride/presentation/components/shimmer/ticket_card_shimmer.dart';
      ...
      builder: (controller) {
        return Scaffold(
                ...
                children: [
                  controller.isLoading
                      ...
                      : (controller.ticketList.isEmpty && controller.isLoading == false)
                          ? Expanded(
                              child: NoDataWidget(
                                text: MyStrings.noSupportTicket.tr,
                              ),
                            )
                          : Expanded(
                              child: ListView.separated(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            CustomAppCard(
                                              ...
                                              backgroundColor: TicketHelper.getStatusColor(
                                                ticket.status ?? "0",
                                              ).withValues(alpha: 0.2),
                                              borderColor: TicketHelper.getStatusColor(
                                                ticket.status ?? "0",
                                              ),
                                              child: Text(
                                                TicketHelper.getPriorityText(
                                                  ticket.status ?? '0',
                                                ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            CustomAppCard(
                                              ...
                                              backgroundColor: TicketHelper.getPriorityColor(
                                                ticket.priority ?? "0",
                                              ).withValues(alpha: 0.2),
                                              borderColor: TicketHelper.getPriorityColor(
                                                ticket.priority ?? "0",
                                              ),
                                              child: Text(
                                                TicketHelper.getPriorityText(
                                                ...
                                                style: regularDefault.copyWith(
                                                  color: TicketHelper.getPriorityColor(
                                                    ticket.priority ?? "0",
                                                  ),
                                                ),
                                              ),
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () {
              Get.toNamed(
                RouteHelper.createSupportTicketScreen,
