...
class _RideActivityScreenState extends State<RideActivityScreen>
  ...
  void initState() {
    ...
    var controller = Get.put(
      AllRideController(repo: Get.find(tag: 'driver')),
      tag: 'driver',
    );
            ...
            children: [
              ...
              Container(
                ...
                child: TabBar(
                  ...
                  indicatorSize:
                      TabBarIndicatorSize.label, // المؤشر تحت النص فقط
