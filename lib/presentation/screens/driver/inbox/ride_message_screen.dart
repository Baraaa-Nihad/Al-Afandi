...
class _RideMessageScreenState extends State<RideMessageScreen> {
  ...
  void initState() {
    ...
    Get.put(RideDetailsController(repo: Get.find(tag: 'driver'), mapController: Get.find(tag: 'driver')), tag: 'driver');
    final controller = Get.put(RideMessageController(repo: Get.find(tag: 'driver')), tag: 'driver');
    Get.put(
  ...
  void dispose() {
    super.dispose();
    // Get.find<RideMessageController>(tag: 'driver').updateCount(0);
  }
